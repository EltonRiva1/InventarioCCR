 ...
 */
package br.com.grupoccr.intranet.inventario.util;
...
public class FabricaConexao {
    ...
    private static final String URL_CONEXAO = "jdbc:mysql://localhost/inventarioccr", USARIO = "root", SENHA = "";

    public static Connection getConexao() throws ErroSistema {
        if (conexao == null) {
            try {
                Class.forName("com.mysql.jdbc.Driver");
                conexao = DriverManager.getConnection(URL_CONEXAO, USARIO, SENHA);
